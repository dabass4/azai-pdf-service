...
sleep 5
curl -s https://healthcare-tracking.preview.emergentagent.com/api/health || echo "FAIL: Backend not responding"

# 2. Test Database Connection
echo "[2/8] Testing database connection..."
# Should return list of timesheets
curl -s https://healthcare-tracking.preview.emergentagent.com/api/timesheets | grep -q "id" && echo "PASS" || echo "FAIL"

# 3. Test Authentication
echo "[3/8] Testing authentication..."
curl -s -X POST https://healthcare-tracking.preview.emergentagent.com/api/auth/login \
...
curl -s -X POST https://healthcare-tracking.preview.emergentagent.com/api/timesheets/upload \
...
curl -s https://healthcare-tracking.preview.emergentagent.com/ | grep -q "AZAI" && echo "PASS" || echo "FAIL"
