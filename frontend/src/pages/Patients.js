      ...
      render: () => (
        <div className="space-y-6">
          <div className="bg-purple-600 text-white p-4 rounded-lg text-center">
            ...
            <p className="text-sm">Ohio patients may change insurance monthly</p>
          </div>
          <div className="bg-green-100 border border-green-400 p-6 rounded-lg text-center">
            <p className="text-2xl font-bold text-green-800">✓ STEP 4 IS WORKING</p>
            <p className="text-green-700 mt-2">If you see this message, the step navigation is fixed.</p>
            <p className="text-sm text-gray-600 mt-4">Form fields will be added back after confirming this works.</p>
          </div>
        </div>
      )
    }
