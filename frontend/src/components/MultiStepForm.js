...
const MultiStepForm = ({ 
  ...
  const handleNext = () => {
    ...
    if (validateStep()) {
      if (currentStep < steps.length - 1) {
        ...
        console.log('[MultiStepForm] Already at last step!');
      }
    }
  };
  ...
  console.log('[MultiStepForm] RENDER - currentStep:', currentStep, 'steps.length:', steps.length, 'isLastStep:', isLastStep);
