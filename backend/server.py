...
async def extract_timesheet_data(file_path: str, file_type: str, page_number: int = 1, progress_tracker: ExtractionProgress = None) -> Tuple[ExtractedData, float, dict]:
    ...
    try:
        ...
        # Using Gemini 2.0 Flash for fast, reliable OCR
        # This model provides excellent accuracy with much faster response times
        # Alternatives: "gemini-2.5-pro" (slower but slightly more accurate), "gpt-4o" (OpenAI)
        chat = LlmChat(
...
async def create_checkout(
    ...
    try:
        ...
        app_url = os.environ.get("APP_URL", "https://claim-tracker-21.preview.emergentagent.com")
